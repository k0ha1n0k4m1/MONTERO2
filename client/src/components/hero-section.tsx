  ...
  return (
    <section className="pt-16 min-h-[80vh] flex items-center">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16 w-full">
        <div className="text-center fade-in bg-black/20 backdrop-blur-md rounded-2xl p-8 lg:p-12 shadow-2xl">
          <h2 className="text-6xl md:text-7xl lg:text-9xl font-bold tracking-wider mb-8 montero-title text-white">
            (MonTero)
          </h2>
          <div className="mt-8">
            <Button 
